			...
			<div class="playback" [ngClass]="{'playback--shown': true}">
				...
				<ion-toolbar>
					<div slot="start" class="playback__timing">
						<span class="playback__timing--current">{{ playerStore.currentTrackSeeker$ | async | fromSeconds }}</span>
...
export class PlaybackControl {
	...
	private trackSeeker$: Observable<number>;
	...
	constructor(
		...
		this.trackSeeker$ = this.playerStore.currentTrackSeeker$.pipe(
			filter(() => !this.isRangeSliderMoving)
		);
	}
